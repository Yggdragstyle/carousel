...
var Slider = /*#__PURE__*/function (_Array) {
  ...
  function Slider() {
    ...
    return _super.call.apply(_super, [this].concat(_toConsumableArray(slides)));
  } // M U T T A T O R S
...
var Carousel = /*#__PURE__*/function () {
  ...
  function Carousel($container) {
    ...
    var slides = Array.from(this.$container.querySelectorAll('.carousel-slide'));
    if (0 === slides.filter(isHTMLElement).length) throw new Error('Carousel must contain at least one slide');
    this.slider = _construct(Slider, _toConsumableArray(slides)); // Keep instance in static
